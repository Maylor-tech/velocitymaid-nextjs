# Jamaica Marketing Assets

This folder contains marketing assets for VelocityMaid Jamaica.

## Required PNG Files

Please create the following PNG files (1200x630px for social media, 1920x1080px for posters):
...
- Consistent branding
- Jamaica-specific imagery (optional)
- VelocityMaid logo included
