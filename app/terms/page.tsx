      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-vm-text">Terms of Service</h1>
          </div>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4 flex items-center">
              <Scale className="w-6 h-6 mr-2 text-vm-cyan-dark" />
              Agreement to Terms
            </h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Service Description</h2>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Service Area</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Booking and Payment</h2>
            <h3 className="text-xl font-semibold text-vm-text mb-3">Booking Process</h3>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4 flex items-center">
              <AlertCircle className="w-6 h-6 mr-2 text-vm-cyan-dark" />
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Customer Responsibilities</h2>
            <p className="text-vm-text leading-relaxed mb-4">
              You agree to:
            </p>
            <ul className="list-disc pl-6 text-vm-text space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Satisfaction Guarantee</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Limitation of Liability</h2>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Insurance</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Intellectual Property</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Prohibited Uses</h2>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Changes to Terms</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Governing Law</h2>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Contact Information</h2>
            <p className="text-vm-text leading-relaxed mb-4">
