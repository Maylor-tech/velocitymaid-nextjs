      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-6">
                <Link href="/jamaica" className="text-gray-700 hover:text-blue-600">Jamaica</Link>
                <Link href="/jamaica/work-with-us" className="text-gray-700 hover:text-blue-600 font-medium">Work With Us</Link>
                <Link
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Join VelocityMaid?</h2>
              <p className="text-xl text-gray-600">Build a career with professional cleaning services</p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Pay Overview (JMD)</h2>
              <p className="text-xl text-gray-600">Competitive rates with performance bonuses</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Standard Clean</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border-2 border-blue-600">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Deep Clean</h3>
                <p className="text-3xl font-bold text-blue-600 mb-2">JMD $12,000</p>
                <p className="text-gray-600">Per service</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Move In/Out</h3>
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md border-2 border-green-200">
                <h4 className="text-lg font-bold text-gray-900 mb-3">Daily Earnings Example</h4>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border-2 border-blue-200">
                <h4 className="text-lg font-bold text-gray-900 mb-3">Weekly Earnings Example</h4>
                <div className="space-y-2">
                  <div className="flex justify-between text-gray-700">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Jamaica Certified Cleaner</h2>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">What Our Cleaners Say</h2>
              <p className="text-xl text-gray-600">Hear from cleaners who are building their careers with VelocityMaid</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="font-semibold text-gray-900">— Port Antonio Cleaner</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-400">Professional cleaning services across Jamaica</p>
              </div>
              <div>
                <h4 className="text-lg font-bold mb-4">Quick Links</h4>
                <ul className="space-y-2">
                  <li><Link href="/jamaica" className="text-gray-400 hover:text-white transition">Jamaica</Link></li>
                  <li><Link href="/jamaica/work-with-us" className="text-gray-400 hover:text-white transition">Work With Us</Link></li>
                  <li><Link href="/locations/port-antonio" className="text-gray-400 hover:text-white transition">Port Antonio</Link></li>
                </ul>
              </div>
              <div>
