...
import { CheckCircle2, Circle, PlayCircle, Filter } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-3xl font-bold text-gray-900">Cleaner Training Status</h1>
            <Link
          ...
          <p className="text-gray-600">Monitor training progress for all cleaners (Jamaica branch)</p>
        </div>
                  ...
                  filteredCleaners.map((cleaner) => (
                    <tr key={cleaner.cleanerId} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                          <div
                            ...
                            style={{
                              width: `${
                                cleaner.totalLessons > 0
                                  ? (cleaner.completedLessons / cleaner.totalLessons) * 100
                                  : 0
                              }%`,
                            }}
                          ></div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link
                          href={`/admin/cleaners/training/${cleaner.cleanerId}`}
