...
export default function BookingHistoryPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-vm-text mb-2">Booking History</h1>
        <p className="text-vm-muted">View your past cleanings and reviews</p>
      </div>
                    ...
                    {review ? (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div>
                            <p className="text-sm text-vm-muted mb-1">Your Review</p>
                            {renderStars(review.rating)}
                          </div>
                          {review.comment && (
                            <p className="text-sm text-vm-text italic">"{review.comment}"</p>
                          )}
                        </div>
                        <Link
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-sm text-vm-muted">No review yet</p>
                        <Link
                          href={`/review/${booking.id}`}
                          className="inline-flex items-center gap-2 px-4 py-2 bg-vm-warning text-white rounded-lg hover:bg-vm-warning transition-colors text-sm font-medium"
                        >
