...
export default function LeadStats({ stats }: LeadStatsProps) {
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-vm-text mb-4">Lead Qualification - New Jersey</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <p className="text-sm text-vm-muted mb-1">Leads This Week</p>
        ...
        <div className="bg-yellow-50 rounded-lg p-4">
          ...
          <p className="text-sm text-vm-muted mb-1">Tier B</p>
        ...
        <div className="bg-orange-50 rounded-lg p-4">
          ...
          <p className="text-sm text-vm-muted mb-1">Tier C</p>
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          ...
          <p className="text-sm text-vm-muted mb-1">Conversion Rate</p>
