      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            <RefreshCw className="w-8 h-8 text-vm-cyan-dark" />
            <h1 className="text-4xl font-bold text-vm-text">Refund Policy</h1>
          </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4 flex items-center">
              <Clock className="w-6 h-6 mr-2 text-vm-cyan-dark" />
              Cancellation Policy
            </h2>
            <h3 className="text-xl font-semibold text-vm-text mb-3">Cancellation by Customer</h3>
            <div className="space-y-4 mb-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="font-semibold text-vm-text mb-2">More than 24 hours before service:</p>
                <p className="text-vm-text">Full refund or reschedule at no charge</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="font-semibold text-vm-text mb-2">Less than 24 hours before service:</p>
                <p className="text-vm-text">50% refund or reschedule (subject to availability)</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="font-semibold text-vm-text mb-2">Same-day cancellation or no-show:</p>
                <p className="text-vm-text">No refund (service may be rescheduled for a fee)</p>
              </div>
            </div>

            <h3 className="text-xl font-semibold text-vm-text mb-3">Cancellation by VelocityMaid</h3>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Refund Process</h2>
            <h3 className="text-xl font-semibold text-vm-text mb-3">How to Request a Refund</h3>
            <ol className="list-decimal pl-6 text-vm-text space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-vm-text mb-3">Refund Methods</h3>
            <p className="text-vm-text leading-relaxed">
            ...
            <ul className="list-disc pl-6 text-vm-text space-y-2 mt-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Partial Refunds</h2>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Disputes and Resolution</h2>
            <p className="text-vm-text leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Special Circumstances</h2>
            <h3 className="text-xl font-semibold text-vm-text mb-3">Recurring Services</h3>
            <p className="text-vm-text leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-vm-text mb-3">Move In/Out Services</h3>
            <p className="text-vm-text leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-vm-text mb-4">Policy Updates</h2>
            <p className="text-vm-text leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <Link href="/privacy" className="text-vm-cyan-dark hover:text-vm-cyan-dark">Privacy Policy</Link>
