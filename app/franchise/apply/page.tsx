  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Business Experience</h2>
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="hasBusinessExperience" className="text-sm font-medium text-gray-700">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-5 h-5 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                />
                <label htmlFor="hasCleaningExperience" className="text-sm font-medium text-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-3 pt-8">
                <input
                  ...
                  className="w-5 h-5 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                />
                <label htmlFor="financingNeeded" className="text-sm font-medium text-gray-700">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Investment Range: {formData.investmentRange}</p>
                <p className="text-gray-600">Liquid Capital: {formData.liquidCapital}</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Timeline</h3>
                <p className="text-gray-600">{formData.timeline}</p>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Franchise Application</h1>
            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  ...
                  <p className={`text-xs mt-2 text-center ${index === currentStep ? 'text-primary-600 font-semibold' : 'text-gray-600'}`}>
                    {step.title}
                  </p>
                </div>
