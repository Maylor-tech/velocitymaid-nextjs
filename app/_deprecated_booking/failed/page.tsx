    ...
    <div className="min-h-screen bg-gradient-to-br from-vm-surface to-white">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 text-center">
          ...
          <h1 className="text-4xl font-bold text-vm-text mb-4">Payment didn't go through</h1>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8 text-left">
            <h2 className="font-semibold text-vm-text mb-3">Common reasons:</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center bg-gray-100 hover:bg-gray-200 text-vm-text font-semibold py-3 px-8 rounded-lg transition"
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-vm-muted mb-2">Need help?</p>
            <p className="text-sm text-vm-text">
              Call us at <a href="tel:+18027335348" className="text-vm-cyan-dark hover:text-vm-cyan-dark font-semibold">(802) 733-5348</a> or{' '}
              <a href="mailto:hello@velocitymaid.com" className="text-vm-cyan-dark hover:text-vm-cyan-dark font-semibold">email us</a>
            </p>
          </div>
        </div>
      </div>
